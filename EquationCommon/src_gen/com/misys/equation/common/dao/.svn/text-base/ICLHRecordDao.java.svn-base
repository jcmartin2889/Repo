 ...
 * @author deroset
 */
public interface ICLHRecordDao extends IDao
{
	...
	/**
	 * This method is going to return a <code>CLHRecordDataModel</code> base on CLH ID
	 * 
	 * @return a <code>CLHRecordDataModel</code> base on [FILED ID]
	 */
