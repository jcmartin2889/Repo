 ...
 * @author deroset
 */
public interface ICLCRecordDao extends IDao
{
	...
	/**
	 * This method is going to return a <code>CLCRecordDataModel</code> base on CLC ID
	 * 
	 * @return a <code>CLCRecordDataModel</code> base on [FILED ID]
	 */
