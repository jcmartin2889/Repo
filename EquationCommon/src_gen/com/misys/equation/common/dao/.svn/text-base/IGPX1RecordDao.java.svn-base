 ...
 * @author deroset
 */
public interface IGPX1RecordDao extends IDao
{
	...
	/**
	 * This method is going to return a <code>GPX1RecordDataModel</code> base on GPX1 ID
	 * 
	 * @return a <code>GPX1RecordDataModel</code> base on [FILED ID]
	 */
