 ...
 * @author deroset
 */
public interface IGPURecordDao extends IDao
{
	...
	/**
	 * This method is going to return a <code>GPURecordDataModel</code> base on GPU ID
	 * 
	 * @return a <code>GPURecordDataModel</code> base on [FILED ID]
	 */
