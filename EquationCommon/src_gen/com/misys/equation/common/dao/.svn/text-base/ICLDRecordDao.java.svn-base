 ...
 * @author deroset
 */
public interface ICLDRecordDao extends IDao
{
	...
	/**
	 * This method is going to return a <code>CLDRecordDataModel</code> base on CLD ID
	 * 
	 * @return a <code>CLDRecordDataModel</code> base on [FILED ID]
	 */
