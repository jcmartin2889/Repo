 ...
 * @author deroset
 */
public interface IEQSRecordDao extends IDao
{
	...
	/**
	 * This method is going to return a <code>EQSRecordDataModel</code> base on EQS ID
	 * 
	 * @return a <code>EQSRecordDataModel</code> base on [FILED ID]
	 */
