 ...
 * @author deroset
 */
public interface IEDMRecordDao extends IDao
{
	...
	/**
	 * This method is going to return a <code>EDMRecordDataModel</code> base on EDM ID
	 * 
	 * @return a <code>EDMRecordDataModel</code> base on [FILED ID]
	 */
