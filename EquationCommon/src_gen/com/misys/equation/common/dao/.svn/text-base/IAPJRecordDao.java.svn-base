 ...
 * @author deroset
 */
public interface IAPJRecordDao extends IDao
{
	...
	/**
	 * This method is going to return a <code>APJRecordDataModel</code> base on APJ ID
	 * 
	 * @return a <code>APJRecordDataModel</code> base on [FILED ID]
	 */
