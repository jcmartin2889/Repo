 ...
 * @author deroset
 */
public interface IGPERecordDao extends IDao
{
	...
	/**
	 * This method is going to return a <code>GPERecordDataModel</code> base on GPE ID
	 * 
	 * @return a <code>GPERecordDataModel</code> base on [FILED ID]
	 */
