 ...
 * @author deroset
 */
public interface IGPMRecordDao extends IDao
{
	...
	/**
	 * This method is going to return a <code>GPMRecordDataModel</code> base on GPM ID
	 * 
	 * @return a <code>GPMRecordDataModel</code> base on [FILED ID]
	 */
