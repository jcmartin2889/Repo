 ...
 * @author deroset
 */
public interface IGPVRecordDao extends IDao
{
	...
	/**
	 * This method is going to return a <code>GPVRecordDataModel</code> base on GPV ID
	 * 
	 * @return a <code>GPVRecordDataModel</code> base on [FILED ID]
	 */
