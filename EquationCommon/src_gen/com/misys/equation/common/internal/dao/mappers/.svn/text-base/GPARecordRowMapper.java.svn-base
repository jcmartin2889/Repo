 ...
 * 
 */
public class GPARecordRowMapper implements RowMapper
{
	/**
	 * This is the unique class id used for serialisation.
	 */
	private static final long serialVersionUID = 1270638835805l;
	...
	{
		GPARecordResultSetExtractor extractor = new GPARecordResultSetExtractor();
