 ...
 * 
 */
public class GAVRecordRowMapper implements RowMapper
{
	/**
	 * This is the unique class id used for serialisation.
	 */
	private static final long serialVersionUID = 1275040799066l;
	...
	{
		GAVRecordResultSetExtractor extractor = new GAVRecordResultSetExtractor();
