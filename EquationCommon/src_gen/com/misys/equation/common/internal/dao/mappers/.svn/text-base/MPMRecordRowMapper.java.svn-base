 ...
 * 
 */
public class MPMRecordRowMapper implements RowMapper
{
	/**
	 * This is the unique class id used for serialisation.
	 */
	private static final long serialVersionUID = 1276834713136l;
	...
	{
		MPMRecordResultSetExtractor extractor = new MPMRecordResultSetExtractor();
