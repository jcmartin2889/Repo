 ...
 * 
 */
public class APJRecordRowMapper implements RowMapper
{
	/**
	 * This is the unique class id used for serialisation.
	 */
	private static final long serialVersionUID = 1273209982603l;
	...
	{
		APJRecordResultSetExtractor extractor = new APJRecordResultSetExtractor();
