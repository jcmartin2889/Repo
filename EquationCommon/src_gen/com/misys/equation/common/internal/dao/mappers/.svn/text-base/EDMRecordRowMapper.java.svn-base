 ...
 * 
 */
public class EDMRecordRowMapper implements RowMapper
{
	/**
	 * This is the unique class id used for serialisation.
	 */
	private static final long serialVersionUID = 1285137724537l;
	...
	{
		EDMRecordResultSetExtractor extractor = new EDMRecordResultSetExtractor();
