 ...
 * 
 */
public class GPRRecordRowMapper implements RowMapper
{
	/**
	 * This is the unique class id used for serialisation.
	 */
	private static final long serialVersionUID = 1274173436531l;
	...
	{
		GPRRecordResultSetExtractor extractor = new GPRRecordResultSetExtractor();
