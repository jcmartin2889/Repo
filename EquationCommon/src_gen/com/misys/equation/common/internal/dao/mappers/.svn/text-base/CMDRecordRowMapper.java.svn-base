 ...
 * 
 */
public class CMDRecordRowMapper implements RowMapper
{
	/**
	 * This is the unique class id used for serialisation.
	 */
	private static final long serialVersionUID = 1282892038486l;
	...
	{
		CMDRecordResultSetExtractor extractor = new CMDRecordResultSetExtractor();
