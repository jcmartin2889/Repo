 ...
 * 
 */
public class GLURecordRowMapper implements RowMapper
{

	/**
	 * This is the unique class id used for serialisation.
	 */
	private static final long serialVersionUID = 1258127204778l;
	...
	public Object mapRow(ResultSet resultSet, int line) throws SQLException
	{
		...
		GLURecordResultSetExtractor extractor = new GLURecordResultSetExtractor();
