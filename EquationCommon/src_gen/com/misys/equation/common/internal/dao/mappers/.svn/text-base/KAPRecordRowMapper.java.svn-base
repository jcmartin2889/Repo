 ...
 * 
 */
public class KAPRecordRowMapper implements RowMapper
{

	/**
	 * This is the unique class id used for serialisation.
	 */
	private static final long serialVersionUID = 1258388076853l;
	...
	public Object mapRow(ResultSet resultSet, int line) throws SQLException
	{
		...
		KAPRecordResultSetExtractor extractor = new KAPRecordResultSetExtractor();
