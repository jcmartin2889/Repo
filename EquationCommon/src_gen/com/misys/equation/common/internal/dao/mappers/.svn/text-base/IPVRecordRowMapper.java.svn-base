 ...
 * 
 */
public class IPVRecordRowMapper implements RowMapper
{
	/**
	 * This is the unique class id used for serialisation.
	 */
	private static final long serialVersionUID = 1278481552150l;
	...
	{
		IPVRecordResultSetExtractor extractor = new IPVRecordResultSetExtractor();
