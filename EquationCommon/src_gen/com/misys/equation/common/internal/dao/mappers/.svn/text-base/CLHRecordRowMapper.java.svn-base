 ...
 * 
 */
public class CLHRecordRowMapper implements RowMapper
{
	/**
	 * This is the unique class id used for serialisation.
	 */
	private static final long serialVersionUID = 1282561774348l;
	...
	{
		CLHRecordResultSetExtractor extractor = new CLHRecordResultSetExtractor();
