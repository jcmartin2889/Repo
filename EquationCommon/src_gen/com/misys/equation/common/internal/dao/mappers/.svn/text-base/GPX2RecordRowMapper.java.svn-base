 ...
 * 
 */
public class GPX2RecordRowMapper implements RowMapper
{

	/**
	 * This is the unique class id used for serialisation.
	 */
	private static final long serialVersionUID = 1258630646966l;
	...
	public Object mapRow(ResultSet resultSet, int line) throws SQLException
	{
		...
		GPX2RecordResultSetExtractor extractor = new GPX2RecordResultSetExtractor();
