 ...
 * 
 */
public class BranchSecurityWrapper extends SecurityWrapper
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: BranchSecurityWrapper.java 8910 2010-08-26 15:25:20Z MACDONP1 $";
	private static final String PV_ID = "SSC99RW";

	public BranchSecurityWrapper(final EquationStandardSession session, final ResultSet rs, final List<String> securityFields)
	{
