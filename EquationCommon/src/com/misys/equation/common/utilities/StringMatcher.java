...
public class StringMatcher
{
	...
	public static final String _revision = "$Id: StringMatcher.java 10443 2011-02-04 16:28:46Z MACDONP1 $";
	 ...
	 * and '?' for exactly one character.
	 * 
	 * Literal '*' and '?' characters must be escaped in the pattern e.g., "\*" means literal "*", etc.
	 * 
	 * Escaping any other character (including the escape character itself), just results in that character in the pattern. e.g.,
	 * "\a" means "a" and "\\" means "\"
	 * 
