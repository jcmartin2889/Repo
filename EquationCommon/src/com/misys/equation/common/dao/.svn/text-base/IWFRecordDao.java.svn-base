...
public interface IWFRecordDao extends IDao
{
	/**
	...
	/**
	 * This method is going to return a <code>WFRecordDataModel</code> based on class of user
	 * 
	 * @return a <code>WFDataModel</code> based on [WFPF]
	 */
