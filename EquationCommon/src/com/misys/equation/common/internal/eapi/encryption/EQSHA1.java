...
//
// Class: EQSHA1: SHA-1 message digest implementation
//
...
public class EQSHA1
{
	...
	public static final String _revision = "$Id: EQSHA1.java 7607 2010-06-01 17:05:56Z MACDONP1 $";
	...
	{
		return (m_block[nI & 15] = rol(
						m_block[(nI + 13) & 15] ^ m_block[(nI + 8) & 15] ^ m_block[(nI + 2) & 15] ^ m_block[nI & 15], 1));
	}
	...
	private final static byte[] SELFTEST_DIGEST = { (byte) 0x84, (byte) 0x98, (byte) 0x3e, (byte) 0x44, (byte) 0x1c, (byte) 0x3b,
					(byte) 0xd2, (byte) 0x6e, (byte) 0xba, (byte) 0xae, (byte) 0x4a, (byte) 0xa1, (byte) 0xf9, (byte) 0x51,
					(byte) 0x29, (byte) 0xe5, (byte) 0xe5, (byte) 0x46, (byte) 0x70, (byte) 0xf1 };
