...
//
// Class: BinConverter: Utility class for data conversion
//
...
public class EQBinConverter
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: EQBinConverter.java 7206 2010-05-10 12:13:44Z weddelc1 $";

	/** Logger instance */
	private static final EquationLogger LOG = new EquationLogger(EQBinConverter.class);
	 ...
	 *            the target array
	 * @param nSrcOfs
	 *            from which character in the string the conversion should begin, remember that (nSrcPos modulo 2) should equals 0
	 *            normally
	 * @param nDstOfs
		...
		for (nI = 0; nI < nLen; nI++)
		{
			...
			for (nJ = 0; nJ < 2; nJ++)
			{
				...
				else
				{
					...
					{
						LOG.error("invalid hex:" + cActChar);
						LOG.error("indexI:" + Integer.valueOf(nI).toString());
						LOG.error("indexJ:" + Integer.valueOf(nJ).toString());
						blConvertOK = false;
					}
				}
			}
	 ...
	 * @return the string
	 */
	public final static StringBuffer byteArrayToStringBuffer(byte[] data, int nOfs, int nLen)
	{
