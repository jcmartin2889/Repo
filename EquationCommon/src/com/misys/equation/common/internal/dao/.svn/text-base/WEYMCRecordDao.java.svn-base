 ...
 * @author lima
 */
public class WEYMCRecordDao extends AbsEquationDao implements IWEYRecordDao
{

	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: WEYMCRecordDao.java 9725 2010-11-08 12:34:45Z MACDONP1 $";
	public WEYMCRecordDao()
	{
		super(); 
	...
	{
		String fields = " WEYUID=?, WEYOID=?, WEYSID=?, WEYTID=?, WEYLID=?, WEYTYP=?, WEYGOF=?, WEYDTA=?, WEYBDTA=? ";
		return fields;
	}
	...
	public Object[] getParameterizedFieldsValues()
	{
		...
		Object[] object = new Object[] { dataModel.getUserId(), dataModel.getOptionId(), dataModel.getSessionId(),
						...
						dataModel.getBeforeImage(), dataModel.getBeforeImageEQ() };
