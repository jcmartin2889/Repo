 ...
 * 
 */
public class JTRecordRowMapper implements RowMapper
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: JTRecordRowMapper.java 6928 2010-04-14 12:04:49Z MACDONP1 $";
	/**
	...
	{
		JTRecordResultSetExtractor extractor = new JTRecordResultSetExtractor();
