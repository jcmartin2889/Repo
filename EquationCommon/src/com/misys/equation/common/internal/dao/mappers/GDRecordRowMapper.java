 ...
 * 
 */
public class GDRecordRowMapper implements RowMapper
{

	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: GDRecordRowMapper.java 4646 2009-09-07 16:28:30Z weddelc1 $";
	/**
	...
	{
		GDRecordResultSetExtractor extractor = new GDRecordResultSetExtractor();
