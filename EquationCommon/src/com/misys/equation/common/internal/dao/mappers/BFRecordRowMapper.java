 ...
 * 
 */
public class BFRecordRowMapper implements RowMapper
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: BFRecordRowMapper.java 14832 2012-11-05 19:03:33Z williae1 $";
	/**
	...
	{
		BFRecordResultSetExtractor extractor = new BFRecordResultSetExtractor();
