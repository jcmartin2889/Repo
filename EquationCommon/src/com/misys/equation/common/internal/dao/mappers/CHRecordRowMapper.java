 ...
 * 
 */
public class CHRecordRowMapper implements RowMapper
{

	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: CHRecordRowMapper.java 4646 2009-09-07 16:28:30Z weddelc1 $";
	/**
	...
	public Object mapRow(ResultSet resultSet, int line) throws SQLException
	{
		...
		CHRecordResultSetExtractor extractor = new CHRecordResultSetExtractor();
