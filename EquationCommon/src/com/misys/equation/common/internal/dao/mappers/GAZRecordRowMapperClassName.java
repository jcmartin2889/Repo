 ...
 * 
 */
public class GAZRecordRowMapperClassName implements RowMapper
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: GAZRecordRowMapperClassName.java 6928 2010-04-14 12:04:49Z MACDONP1 $";
	/**
	...
	public Object mapRow(ResultSet resultSet, int line) throws SQLException
	{
		...
		GAZRecordResultSetExtractorClassName extractor = new GAZRecordResultSetExtractorClassName();
