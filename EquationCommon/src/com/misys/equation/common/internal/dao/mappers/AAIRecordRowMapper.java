 ...
 * 
 */
public class AAIRecordRowMapper implements RowMapper
{

	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AAIRecordRowMapper.java 6928 2010-04-14 12:04:49Z MACDONP1 $";
	/**
	...
	public Object mapRow(ResultSet resultSet, int line) throws SQLException
	{
		...
		AAIRecordResultSetExtractor extractor = new AAIRecordResultSetExtractor();
