...
/**
 * Class StartLRPProcessRqHeaderDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class StartLRPProcessRqHeaderDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl
{
	...
	public StartLRPProcessRqHeaderDescriptor()
	{
		super();
		_nsURI = "http://www.misys.com/eqf/types/header";
		_xmlName = "StartLRPProcessRqHeader";
		...
		// -- _operationName
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_operationName", "operationName",
		...
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
			...
			{
				StartLRPProcessRqHeader target = (StartLRPProcessRqHeader) object;
	...
	{
		return bf.com.misys.eqf.types.header.StartLRPProcessRqHeader.class;
	}
