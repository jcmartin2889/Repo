...
import bf.com.misys.eqf.types.header.ServiceUserExitRqHeader;

/**
 * Class ServiceUserExitRqHeaderDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ServiceUserExitRqHeaderDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl
{
	...
	public ServiceUserExitRqHeaderDescriptor()
	{
		super();
		_nsURI = "http://www.misys.com/eqf/types/header";
		_xmlName = "serviceUserExitRqHeader";
		...
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
			...
			{
				ServiceUserExitRqHeader target = (ServiceUserExitRqHeader) object;
	...
	{
		return bf.com.misys.eqf.types.header.ServiceUserExitRqHeader.class;
	}
