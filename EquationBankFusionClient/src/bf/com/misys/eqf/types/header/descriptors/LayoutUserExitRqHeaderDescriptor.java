...
import bf.com.misys.eqf.types.header.LayoutUserExitRqHeader;

/**
 * Class LayoutUserExitRqHeaderDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class LayoutUserExitRqHeaderDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl
{
	...
	public LayoutUserExitRqHeaderDescriptor()
	{
		super();
		_nsURI = "http://www.misys.com/eqf/types/header";
		_xmlName = "layoutUserExitRqHeader";
		...
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
			...
			{
				LayoutUserExitRqHeader target = (LayoutUserExitRqHeader) object;
		...
		// -- _curScrn
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_curScrn", "curScrn",
						org.exolab.castor.xml.NodeType.Element);
		desc.setImmutable(true);
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
							...
							IllegalArgumentException
			{
				...
				{
					LayoutUserExitRqHeader target = (LayoutUserExitRqHeader) object;
					target.setCurScrn((java.lang.String) value);
				}
				catch (java.lang.Exception ex)
				{
					throw new IllegalStateException(ex.toString());
	...
	{
		return bf.com.misys.eqf.types.header.LayoutUserExitRqHeader.class;
	}
