...
/**
 * Class UpdateEsfStatusRsHeaderDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class UpdateEsfStatusRsHeaderDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl
{
	...
	public UpdateEsfStatusRsHeaderDescriptor()
	{
		super();
		_nsURI = "http://www.misys.com/eqf/types/header";
		_xmlName = "updateEsfStatusRsHeader";
		...
		// -- _errorCode
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_errorCode", "errorCode",
		...
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
			...
			{
				UpdateEsfStatusRsHeader target = (UpdateEsfStatusRsHeader) object;
		...
		// -- _errorMessage
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_errorMessage", "errorMessage",
						org.exolab.castor.xml.NodeType.Element);
		desc.setImmutable(true);
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
	...
	{
		return bf.com.misys.eqf.types.header.UpdateEsfStatusRsHeader.class;
	}
