...
/**
 * Class StartLRPProcessRsHeaderDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class StartLRPProcessRsHeaderDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl
{
	...
	public StartLRPProcessRsHeaderDescriptor()
	{
		super();
		_nsURI = "http://www.misys.com/eqf/types/header";
		_xmlName = "StartLRPProcessRsHeader";
		...
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
			...
			{
				StartLRPProcessRsHeader target = (StartLRPProcessRsHeader) object;
	...
	{
		return bf.com.misys.eqf.types.header.StartLRPProcessRsHeader.class;
	}
