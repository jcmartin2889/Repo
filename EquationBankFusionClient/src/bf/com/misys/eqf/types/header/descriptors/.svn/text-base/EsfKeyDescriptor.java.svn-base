...
/**
 * Class EsfKeyDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class EsfKeyDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl
{
	...
	public EsfKeyDescriptor()
	{
		...
		desc.setValidator(fieldValidator);
		// -- _transactionId
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_transactionId", "transactionId",
						org.exolab.castor.xml.NodeType.Element);
		desc.setImmutable(true);
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
	...
	{
		return bf.com.misys.eqf.types.header.EsfKey.class;
	}
