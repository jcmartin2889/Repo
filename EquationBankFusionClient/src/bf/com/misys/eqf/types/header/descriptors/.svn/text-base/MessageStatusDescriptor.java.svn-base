...
/**
 * Class MessageStatusDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class MessageStatusDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl
{
	...
	public MessageStatusDescriptor()
	{
		super();
		_nsURI = "http://www.misys.com/eqf/types/header";
		_xmlName = "messageStatus";
		...
		// -- _overallStatus
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_overallStatus", "overallStatus",
		...
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
			...
			{
				MessageStatus target = (MessageStatus) object;
				return target.getOverallStatus();
			}
			@Override
							...
							IllegalArgumentException
			{
				...
				{
					MessageStatus target = (MessageStatus) object;
					target.setOverallStatus((java.lang.String) value);
				}
		...
		// -- validation code for: _overallStatus
		...
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(bf.com.misys.eqf.types.header.EqMessage.class,
						"_eqMessagesList", "eqMessages", org.exolab.castor.xml.NodeType.Element);
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
			@Override
			public java.lang.Object getValue(java.lang.Object object) throws IllegalStateException
							...
							IllegalArgumentException
			{
				...
				{
					MessageStatus target = (MessageStatus) object;
					target.addEqMessages((bf.com.misys.eqf.types.header.EqMessage) value);
				}
				catch (java.lang.Exception ex)
				{
					throw new IllegalStateException(ex.toString());
		...
		// -- validation code for: _eqMessagesList
		fieldValidator = new org.exolab.castor.xml.FieldValidator();
	...
	{
		return bf.com.misys.eqf.types.header.MessageStatus.class;
	}
