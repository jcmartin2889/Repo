...
import bf.com.misys.eqf.types.header.ServiceUserExitRsHeader;

/**
 * Class ServiceUserExitRsHeaderDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ServiceUserExitRsHeaderDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl
{
	...
	public ServiceUserExitRsHeaderDescriptor()
	{
		super();
		_nsURI = "http://www.misys.com/eqf/types/header";
		_xmlName = "serviceUserExitRsHeader";
		...
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
			...
			{
				ServiceUserExitRsHeader target = (ServiceUserExitRsHeader) object;
	...
	{
		return bf.com.misys.eqf.types.header.ServiceUserExitRsHeader.class;
	}
