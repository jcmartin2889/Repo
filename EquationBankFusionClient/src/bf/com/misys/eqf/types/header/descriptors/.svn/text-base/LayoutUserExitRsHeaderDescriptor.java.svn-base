...
import bf.com.misys.eqf.types.header.LayoutUserExitRsHeader;

/**
 * Class LayoutUserExitRsHeaderDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class LayoutUserExitRsHeaderDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl
{
	...
	public LayoutUserExitRsHeaderDescriptor()
	{
		super();
		_nsURI = "http://www.misys.com/eqf/types/header";
		_xmlName = "layoutUserExitRsHeader";
		...
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
			...
			{
				LayoutUserExitRsHeader target = (LayoutUserExitRsHeader) object;
		...
		// -- _nextScrn
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_nextScrn", "nextScrn",
						org.exolab.castor.xml.NodeType.Element);
		desc.setImmutable(true);
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
							...
							IllegalArgumentException
			{
				...
				{
					LayoutUserExitRsHeader target = (LayoutUserExitRsHeader) object;
					target.setNextScrn((java.lang.String) value);
				}
				catch (java.lang.Exception ex)
				{
					throw new IllegalStateException(ex.toString());
	...
	{
		return bf.com.misys.eqf.types.header.LayoutUserExitRsHeader.class;
	}
