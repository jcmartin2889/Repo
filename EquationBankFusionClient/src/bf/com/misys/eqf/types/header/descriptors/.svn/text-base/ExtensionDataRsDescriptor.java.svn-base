...
/**
 * Class ExtensionDataRsDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ExtensionDataRsDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl
{
	...
	public ExtensionDataRsDescriptor()
	{
		super();
		_nsURI = "http://www.misys.com/eqf/types/header";
		_xmlName = "extensionDataRs";
		...
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
			...
			{
				ExtensionDataRs target = (ExtensionDataRs) object;
	...
	{
		return bf.com.misys.eqf.types.header.ExtensionDataRs.class;
	}
