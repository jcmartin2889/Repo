...
/**
 * Class SearchRsHeaderDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class SearchRsHeaderDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl
{
	...
	public SearchRsHeaderDescriptor()
	{
		super();
		_nsURI = "http://www.misys.com/eqf/types/header";
		_xmlName = "searchRsHeader";
		...
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
			...
			{
				SearchRsHeader target = (SearchRsHeader) object;
		...
		// -- _eof
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Boolean.class, "_eof", "eof",
		...
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
							...
							IllegalArgumentException
			{
				...
				{
					SearchRsHeader target = (SearchRsHeader) object;
					target.setEof((java.lang.Boolean) value);
				}
				catch (java.lang.Exception ex)
				{
					throw new IllegalStateException(ex.toString());
	...
	{
		return bf.com.misys.eqf.types.header.SearchRsHeader.class;
	}
