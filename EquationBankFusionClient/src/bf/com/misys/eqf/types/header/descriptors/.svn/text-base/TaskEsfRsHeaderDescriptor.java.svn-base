...
/**
 * Class TaskEsfRsHeaderDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class TaskEsfRsHeaderDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl
{
	...
	public TaskEsfRsHeaderDescriptor()
	{
		super();
		_nsURI = "http://www.misys.com/eqf/types/header";
		_xmlName = "TaskEsfRsHeader";
		...
		// -- _taskAction
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_taskAction", "taskAction",
		...
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
			...
			{
				TaskEsfRsHeader target = (TaskEsfRsHeader) object;
				return target.getTaskAction();
			}
			@Override
							...
							IllegalArgumentException
			{
				...
				{
					TaskEsfRsHeader target = (TaskEsfRsHeader) object;
					target.setTaskAction((java.lang.String) value);
				}
		...
		// -- validation code for: _taskAction
		...
		// -- _reason
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_reason", "reason",
						org.exolab.castor.xml.NodeType.Element);
		desc.setImmutable(true);
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
	...
	{
		return bf.com.misys.eqf.types.header.TaskEsfRsHeader.class;
	}
