...
/**
 * Class BranchKeysDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class BranchKeysDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl
{
	...
	public BranchKeysDescriptor()
	{
		...
		// -- _branchCode
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_branchCode", "branchCode",
		...
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
			...
			{
				BranchKeys target = (BranchKeys) object;
				return target.getBranchCode();
			}
			@Override
							...
							IllegalArgumentException
			{
				...
				{
					BranchKeys target = (BranchKeys) object;
					target.setBranchCode((java.lang.String) value);
				}
		...
		// -- validation code for: _branchCode
		...
		// -- _branchMnemonic
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_branchMnemonic", "branchMnemonic",
						org.exolab.castor.xml.NodeType.Element);
		desc.setImmutable(true);
		handler = new org.exolab.castor.xml.XMLFieldHandler()
		{
			...
			{
				BranchKeys target = (BranchKeys) object;
				return target.getBranchMnemonic();
			}
			@Override
			public void setValue(java.lang.Object object, java.lang.Object value) throws IllegalStateException,
							IllegalArgumentException
			{
				...
				{
					BranchKeys target = (BranchKeys) object;
					target.setBranchMnemonic((java.lang.String) value);
				}
				catch (java.lang.Exception ex)
				{
					throw new IllegalStateException(ex.toString());
		...
		// -- validation code for: _branchMnemonic
		fieldValidator = new org.exolab.castor.xml.FieldValidator();
		{ // -- local scope
			org.exolab.castor.xml.validators.StringValidator typeValidator;
			typeValidator = new org.exolab.castor.xml.validators.StringValidator();
	...
	{
		return bf.com.misys.eqf.types.header.BranchKeys.class;
	}
