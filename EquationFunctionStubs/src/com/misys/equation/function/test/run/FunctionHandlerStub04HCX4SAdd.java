...
// Via API
public class FunctionHandlerStub04HCX4SAdd extends FunctionHandlerStubTestCase
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: FunctionHandlerStub04HCX4SAdd.java 6793 2010-03-31 12:10:20Z deroset $";

	public FunctionHandlerStub04HCX4SAdd()
	{
		try
		{
			setUp();
	...
	{
		FunctionHandlerStub04HCX4SAdd test = new FunctionHandlerStub04HCX4SAdd();
		test.test();
	}
