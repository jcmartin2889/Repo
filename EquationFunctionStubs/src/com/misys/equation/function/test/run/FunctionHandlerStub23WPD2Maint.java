...
// Via API
public class FunctionHandlerStub23WPD2Maint extends FunctionHandlerStubTestCase
{

	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: FunctionHandlerStub23WPD2Maint.java 6793 2010-03-31 12:10:20Z deroset $";
	public FunctionHandlerStub23WPD2Maint()
	{
		try
		{
			setUp();
	...
	{
		FunctionHandlerStub23WPD2Maint test = new FunctionHandlerStub23WPD2Maint();
		test.test();
	}
	...
	public boolean test()
	{
		...
		try
		{
			...
			functionData2.chgFieldInputValue("WPD_PRDDSC", "this is UPDATED desc");
	...
	{
		FunctionHandlerStub23WPD2Maint stub = new FunctionHandlerStub23WPD2Maint();
