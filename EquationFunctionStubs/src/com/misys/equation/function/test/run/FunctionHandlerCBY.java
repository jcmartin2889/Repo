...
// Via API
public class FunctionHandlerCBY extends FunctionHandlerStubTestCase
{

	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: FunctionHandlerCBY.java 6793 2010-03-31 12:10:20Z deroset $";
	public FunctionHandlerCBY()
	{
		try
		{
			setUp();
	...
	{
		FunctionHandlerCBY test = new FunctionHandlerCBY();
		test.test();
	}
	...
	public boolean test()
	{
		...
		try
		{
			...
			functionHandler2.doNewTransaction("CBY", "");
