...
// Via API
public class FunctionHandlerStub17ALU2Maint extends FunctionHandlerStubTestCase
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: FunctionHandlerStub17ALU2Maint.java 6793 2010-03-31 12:10:20Z deroset $";

	public FunctionHandlerStub17ALU2Maint()
	{
		try
		{
			setUp();
	...
	{
		FunctionHandlerStub17ALU2Maint test = new FunctionHandlerStub17ALU2Maint();
		test.test();
	}
	...
	public boolean test()
	{
		...
		try
		{
			...
			{
				// details
				functionData.chgFieldInputValue("ADRF", "M" + date);
				functionData.chgFieldInputValue("ADSC", "M" + date);
	...
	public void testStub17ALU2Maint()
	{
		FunctionHandlerStub17ALU2Maint stub = new FunctionHandlerStub17ALU2Maint();
