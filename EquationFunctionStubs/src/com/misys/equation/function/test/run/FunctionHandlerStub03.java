...
// Via API
public class FunctionHandlerStub03 extends FunctionHandlerStubTestCase
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: FunctionHandlerStub03.java 7610 2010-06-01 17:10:41Z MACDONP1 $";

	public FunctionHandlerStub03()
	{
		try
		{
			setUp();
	...
	public FunctionHandlerStub03(EquationUnit unit, EquationUser user, EquationStandardSession session)
	{
	...
	{
		FunctionHandlerStub03 test = new FunctionHandlerStub03();
		test.test();
	}
	...
	{
		FunctionHandlerStub03 stub = new FunctionHandlerStub03();
