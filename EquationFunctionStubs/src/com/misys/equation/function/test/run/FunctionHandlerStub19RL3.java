 ...
 * 
 */
public class FunctionHandlerStub19RL3 extends FunctionHandlerStubTestCase
{

	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: FunctionHandlerStub19RL3.java 6793 2010-03-31 12:10:20Z deroset $";
	public FunctionHandlerStub19RL3()
	{
		try
		{
			setUp();
	...
	{
		FunctionHandlerStub19RL3 test = new FunctionHandlerStub19RL3();
		test.test();
	}
	...
	public boolean test()
	{
		...
		try
		{
			...
			functionHandler.doNewTransaction("RL3", "");
			...
			functionData.chgFieldInputValue("LNP", "CR3");
			functionData.chgFieldInputValue("LNR", LNR2);
			// functionData.chgFieldInputValue("BRNM", "");
			functionData.chgFieldInputValue("CUS", "ACCS");
			functionData.chgFieldInputValue("CLC", "DTA");
			functionData.chgFieldInputValue("CCY", "GBP");
			functionData.chgFieldInputValue("DLA", "10T");
			functionData.chgFieldInputValue("SDTE", "011299");
	...
	{
		FunctionHandlerStub19RL3 stub = new FunctionHandlerStub19RL3();
