...
// Via API
public class FunctionHandlerStub03NoEFC extends FunctionHandlerStubTestCase
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: FunctionHandlerStub03NoEFC.java 6793 2010-03-31 12:10:20Z deroset $";

	public FunctionHandlerStub03NoEFC()
	{
		try
		{
			setUp();
	...
	{
		FunctionHandlerStub03NoEFC test = new FunctionHandlerStub03NoEFC();
		test.test();
	}
	...
	public boolean test()
	{
		...
		try
		{
			...
			functionData.chgFieldInputValue("DRF", "No EFC");
			...
			functionData.chgFieldDbValue("RAT1", "123.1234567");
	...
	{
		FunctionHandlerStub03NoEFC stub = new FunctionHandlerStub03NoEFC();
