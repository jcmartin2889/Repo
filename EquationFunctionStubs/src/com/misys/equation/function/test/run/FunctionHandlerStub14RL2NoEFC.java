 ...
 * 
 */
public class FunctionHandlerStub14RL2NoEFC extends FunctionHandlerStubTestCase
{

	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: FunctionHandlerStub14RL2NoEFC.java 6793 2010-03-31 12:10:20Z deroset $";
	public FunctionHandlerStub14RL2NoEFC()
	{
		try
		{
			setUp();
	...
	{
		FunctionHandlerStub14RL2NoEFC test = new FunctionHandlerStub14RL2NoEFC();
		test.test();
	}
	...
	public boolean test()
	{
		...
		try
		{
			...
			functionData.chgFieldInputValue(FunctionData.FLD_EFC, "N");
			...
			functionData.chgFieldInputValue("CUS", "009041");
			functionData.chgFieldInputValue("CLC", "164");
	...
	public void testStub14RL2NoEFC()
	{
		FunctionHandlerStub14RL2NoEFC stub = new FunctionHandlerStub14RL2NoEFC();
