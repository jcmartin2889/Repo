...
public class VV2 extends TestOptionStub
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: VV2.java 6793 2010-03-31 12:10:20Z deroset $";
	...
	private DisplayFieldSetWrapper addRecord1(FunctionGenerator fg) throws EQException
	{
		...
		VV1.addPromptField(session, inputFieldSet, attributeSet, "DTR01R", "DTR01R", "A", 50, "DTR01R", "", false, "");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "SXR01R", "SXR01R", "A", 50, "SXR01R", "", false, "");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "GWV13R", "GWV13R", "A", 50, "GWV13R", "", false, "");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "SCR20R", "SCR20R", "A", 50, "SCR20R", "", false, "");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "NER20R", "NER20R", "A", 50, "NER20R", "", false, "");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "SCR10R", "SCR10R", "A", 50, "SCR10R", "", false, "");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "NER10R", "NER10R", "A", 50, "NER10R", "", false, "");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "SCR11R", "SCR11R", "A", 50, "SCR11R", "", false, "");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "NER11R", "NER11R", "A", 50, "NER11R", "", false, "");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "AAHR11R", "AAHR11R", "A", 100, "AAHR11R", "", false, "");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "AAHR12R", "AAHR12R", "A", 100, "AAHR12R", "", false, "");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "AAHR13R", "AAHR13R", "A", 100, "AAHR13R", "", false, "");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "AAHR14R", "AAHR14R", "A", 100, "AAHR14R", "", false, "");
