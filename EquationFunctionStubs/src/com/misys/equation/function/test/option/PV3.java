...
public class PV3 extends TestOptionStub
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: PV3.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	private DisplayFieldSetWrapper addRecord1(FunctionGenerator fg) throws EQException
	{
		...
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "WER01R", "WER01R", "", 10, "WER01R", "", false, "N");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "$AMBMIC", "AMBR10R", "", 40, "AMBR10R", "", false, "N");

		// VV1.addPromptField(session, inputFieldSet, attributeSet, "NER40R", "NER40R", "", 50, "NER40R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "MSV40R", "MSV40R", "", 10, "MSV40R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "AMCR10R", "AMCR10R", "", 50, "AMCR10R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "AMAR10R", "AMAR10R", "", 50, "AMAR10R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "CCAR01R", "CCAR01R", "", 50, "CCAR01R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "JYR50R", "JYR50R", "", 50, "JYR50R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "LCR01R", "LCR01R", "", 50, "LCR01R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "MJR10R", "MJR10R", "", 50, "MJR10R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "N4R01R", "N4R01R", "", 50, "N4R01R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "QQAR10R", "QQAR10R", "", 50, "QQAR10R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "RKR10R", "RKR10R", "", 50, "RKR10R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "SAR50R", "SAR50R", "", 50, "SAR50R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "S9R01R", "S9R01R", "", 50, "S9R01R", "", false, "N");

		// VV1.addPromptField(session, inputFieldSet, attributeSet, "EXER10R", "EXER10R", "", 50, "EXER10R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "SAR50R", "SAR50R", "", 50, "SAR50R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "OMR03R", "OMR03R", "", 47, "OMR03R", "", false, "N");
		// VV1.addField(session, inputFieldSet, attributeSet, "MSV32R", "MSV32R", "A", 1, "MSV32R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "GVR10R", "GVR10R", "", 20, "GVR10R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "DVR01R", "DVR01R", "", 20, "DVR01R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "C7R05R", "C7R05R", "", 2, "C7R05R", "", false, "N");
