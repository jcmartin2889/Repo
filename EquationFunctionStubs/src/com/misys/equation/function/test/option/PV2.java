...
public class PV2 extends TestOptionStub
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: PV2.java 4735 2009-09-15 16:58:25Z lima12 $";
	...
	private DisplayFieldSetWrapper addRecord1(FunctionGenerator fg) throws EQException
	{
		...
		VV1.addPromptField(session, inputFieldSet, attributeSet, "Q8R10R", "Q8R10R", "", 2, "Q8R10R", "", false, "");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "OMR03R", "OMR03R", "", 2, "OMR03R", "", false, "");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "OMR03R", "OMR03R", "", 2, "OMR03R", "", false, "");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "TYR10R", "TYR10R", "", 2, "TYR10R", "", false, "");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "P3R03R", "P3R03R", "", 2, "P3R03R", "", false, "");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "QMR10R", "QMR10R", "", 40, "QMR10R", "", false, "");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "H0R10R", "H0R10R", "", 2, "H0R10R", "", false, "");

		// VV1.addPromptField(session, inputFieldSet, attributeSet, "AAIR10R", "AAIR10R", "", 2, "AAIR10R", "", false, "");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "AAJR10R", "AAJR10R", "", 2, "AAJR10R", "", false, "");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "AAKR10R", "AAKR10R", "", 2, "AAKR10R", "", false, "");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "AAKR15R", "AAKR15R", "", 2, "AAKR15R", "", false, "");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "AALR10R", "AALR10R", "", 2, "AALR10R", "", false, "");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "AANR10R", "AANR10R", "", 2, "AANR10R", "", false, "");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "AAPR10R", "AAPR10R", "", 2, "AAPR10R", "", false, "");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "AASR10R", "AASR10R", "", 2, "AASR10R", "", false, "");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "AAWR10R", "AAWR10R", "", 2, "AAWR10R", "", false, "");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "AAXR10R", "AAXR10R", "", 2, "AAXR10R", "", false, "");
