...
public class PVQ extends TestOptionStub
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: PVQ.java 4735 2009-09-15 16:58:25Z lima12 $";
	...
	private DisplayFieldSetWrapper addRecord1(FunctionGenerator fg) throws EQException
	{
		...
		VV1.addPromptField(session, inputFieldSet, attributeSet, "OCR32R", "OCR32R", "A", 50, "OCR32R", " ", false, "");
	...
	private void test()
	{
		...
		try
		{
			FunctionGenerator fg = new FunctionGenerator(this.getClass().getSimpleName(), "Test Stub",
							"This is the description of Supervisers prompt", "com.misys.equation.screens",
