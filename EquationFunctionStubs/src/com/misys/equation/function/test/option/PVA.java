...
// Jane Todd's copy of PV1 to test PVs
public class PVA extends TestOptionStub
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: PVA.java 12411 2011-12-21 18:02:15Z TODDJ1 $";
	...
	private DisplayFieldSetWrapper addRecord1(FunctionGenerator fg) throws EQException
	{
		...
		VV1.addPromptField(session, inputFieldSet, attributeSet, "AA5R10R", "AA5R10R", "", 78, "AA5R10R", "", false, "N");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "LTR01R", "LTR01R", "", 109, "LTR01R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "IPAR01R", "IPAR01R", "", 127, "IPAR01R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "IPAR01R-A", "IPAR01R-A", "", 127, "IPAR01R", "A", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "IPAR01R-B", "IPAR01R-B", "", 127, "IPAR01R", "B", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "IPAR01R-I", "IPAR01R-I", "", 127, "IPAR01R", "I", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "IPAR01R-1", "IPAR01R-1", "", 127, "IPAR01R", "1", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "IPAR01R-2", "IPAR01R-2", "", 127, "IPAR01R", "2", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "IPBR01R", "IPBR01R", "", 47, "IPBR01R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "IPBR01R-A", "IPBR01R-A", "", 47, "IPBR01R", "A", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "IPBR01R-I", "IPBR01R-I", "", 47, "IPBR01R", "I", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "IPCR01R", "IPCR01R", "", 47, "IPCR01R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "IPCR01R-A", "IPCR01R-A", "", 47, "IPCR01R", "A", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "IPCR01R-I", "IPCR01R-I", "", 47, "IPCR01R", "I", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "IPCR01R-M", "IPCR01R-M", "", 47, "IPCR01R", "M", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "IPDR01R", "IPDR01R", "", 66, "IPDR01R", "", false, "N");
		// VV1.addPromptField(session, inputFieldSet, attributeSet, "IPHR01R", "IPHR01R", "", 59, "IPHR01R", "", false, "N");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "TIDR10R", "TIDR10R", "", 128, "TIDR10R", "", false, "N");
		VV1.addPromptField(session, inputFieldSet, attributeSet, "TIDR10R-A", "TIDR10R-A", "", 128, "TIDR10R", "A", false, "N");
