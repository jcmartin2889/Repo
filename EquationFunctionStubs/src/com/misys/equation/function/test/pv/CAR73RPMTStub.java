 ...
 * 
 */
public class CAR73RPMTStub extends FunctionHandlerStubTestCase
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: CAR73RPMTStub.java 6793 2010-03-31 12:10:20Z deroset $";

	public CAR73RPMTStub()
	{
		try
		{
			setUp();
	...
	{
		CAR73RPMTStub test = new CAR73RPMTStub();
		test.test();
	}
