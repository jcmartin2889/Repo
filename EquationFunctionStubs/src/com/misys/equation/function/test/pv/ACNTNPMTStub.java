 ...
 * 
 */
public class ACNTNPMTStub extends FunctionHandlerStubTestCase
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: ACNTNPMTStub.java 7645 2010-06-03 17:49:46Z MACDONP1 $";
	...
	{
		ACNTNPMTStub test = new ACNTNPMTStub();
		test.test();
	}
