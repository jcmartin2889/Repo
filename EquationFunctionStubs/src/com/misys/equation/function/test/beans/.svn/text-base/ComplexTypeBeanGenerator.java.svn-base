...
public class ComplexTypeBeanGenerator
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		String projectName = "C:/Temp/";
		String destinationDirectory = projectName + "src";
		String xsdLocation = "C:/BFEQUXP/workspace3.0.2Test/EquationDesign/services/YCI/bankfusion/EQ_CMN_translationHciYCI.xsd";
		String packageName = "bf.com.misys.equation.bankfusion.service.cmn";
					...
					HashMap<String, String> nspackages) throws Exception
	{
		...
		try
		{
			...
			srcGen.setCreateMarshalMethods(false);
