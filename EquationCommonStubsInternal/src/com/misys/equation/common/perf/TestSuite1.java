...
public class TestSuite1 implements Runnable
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: TestSuite1.java 11310 2011-06-27 12:20:21Z ESTHER.WILLIAMS $";
	...
	String dlp = "RTD";
	String dlr = cus + "0000001";
	String dla = "100000";
	String prc = "Y1";
	String cashUSDAB = "0543";
	String cashUSDAN = "811111";
	String cashUSDAS = "840";
	String xm = "AC";
	...
	public void run()
	{
		try
		{
			TestSuite1 test = new TestSuite1();
			test.test();
		}
		catch (Exception e)
		{
