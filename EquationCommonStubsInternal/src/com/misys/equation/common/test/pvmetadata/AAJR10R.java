...
public class AAJR10R
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AAJR10R.java 11310 2011-06-27 12:20:21Z ESTHER.WILLIAMS $";
	...
	public void test()
	{
		...
		try
		{
			EquationPVMetaData pvmetadata = session.getUnit().getPVMetaData("AAJR10R");
