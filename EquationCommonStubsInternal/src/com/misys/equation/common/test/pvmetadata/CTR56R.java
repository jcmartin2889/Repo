...
public class CTR56R
{
	...
	public static final String _revision = "$Id: CTR56R.java 11310 2011-06-27 12:20:21Z ESTHER.WILLIAMS $";
	...
	public void test()
	{
		...
		try
		{
			EquationPVMetaData pvmetadata = session.getUnit().getPVMetaData("CTR56R");
