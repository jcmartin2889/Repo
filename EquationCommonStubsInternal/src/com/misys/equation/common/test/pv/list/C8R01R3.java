 ...
 */
// *************************************************************************************************
public class C8R01R3 extends EquationTestCase
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: C8R01R3.java 11310 2011-06-27 12:20:21Z ESTHER.WILLIAMS $";
	// *********************************************************************************************
	/**
	 * 
	 */
	...
	public void test()
	{
		...
		try
		{
			...
			EquationStandardListValidation listValidation = new EquationStandardListValidation(decode, pvModule, equationPVData
							.parseFieldsIntoDSCCN("Y"), "N", "N", "", "", 1, 16);
