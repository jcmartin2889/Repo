...
public class SystemTestCase1
{
	...
	public static final String _revision = "$Id: SystemTestCase1.java 11310 2011-06-27 12:20:21Z ESTHER.WILLIAMS $";
	...
	public static void main(String[] args)
	{
		try
		{
			SystemTestCase1 test = new SystemTestCase1();
			test.test();
		}
		catch (Exception e)
		{
