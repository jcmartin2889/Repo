...
public class MCD
{
	...
	public static final String _revision = "$Id: MCD.java 11310 2011-06-27 12:20:21Z ESTHER.WILLIAMS $";
	EQSession session;
	EQTransaction customerBasicDetails;
	String suffix = "01";
	public MCD()
	{
		try
	...
	public void test()
	{
		try
		{
			...
			customerBasicDetails = (EQTransaction) session.createEQObject("MCD");
			customerBasicDetails.setAuditUserID("Chris W");
			customerBasicDetails.setReference("TRN" + suffix);
			// Set the fields
			customerBasicDetails.setFieldValue("ZLCUS", "HARR" + suffix);
			customerBasicDetails.setFieldValue("ZLCLC", "   ");
			// retrieve default values
			customerBasicDetails.maintain(session, EQTransaction.ACTION_VALIDATE);
			printKeyFieldErrors(customerBasicDetails);
			printFields(customerBasicDetails);
			// Now set detail fields...
			customerBasicDetails.setFieldValue("ZLCRF", "NE166283A");
			// Bang them in
			customerBasicDetails.setAutoOverride(true);
			customerBasicDetails.maintain(session, EQTransaction.ACTION_UPDATE);
			System.out.println("Customer errors   :" + customerBasicDetails.getMessages());
			System.out.println("Customer warnings :" + customerBasicDetails.getOverrides());
