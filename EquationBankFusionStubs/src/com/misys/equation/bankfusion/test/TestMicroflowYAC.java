 ...
 * **********************************************************************************
 * 
 * $Id: TestMicroflowYAC.java 11323 2011-06-29 11:11:42Z GOLDSMC1 $
 * 
 * 
 */
...
import bf.com.misys.eq4.service.yac.YAC;
...
public class TestMicroflowYAC
{
	...
	private static final transient Log logger = LogFactory.getLog(TestMicroflowYAC.class.getName());
	...
	public static void main(String arguments[])
	{
		...
		try
		{
			...
			IExecuteMicroflowRequest executeMicroflowRequst = new ExecuteMicroflowRequest("retail", "YAC");
			try
			{
				YAC bf_functionData = new YAC();
				bf_functionData.setANC_CPNC("555738");
				bf_functionData.setANC_CUN("555738");
				bf_functionData.setANC_DAS("555738");
				bf_functionData.setCAA_NA1("555738");
				bf_functionData.setANX_EAD1("555738");
