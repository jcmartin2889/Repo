 ...
 * YCCDescriptor.java,v 1.1 2009/05/20 06:41:15 weddelc1 Exp $
 */

package bf.com.misys.eq4.service.ycc.descriptors;
 ...
 */
public class YCCDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl
{
	...
	public YCCDescriptor()
	{
		super();
		_nsURI = "http://www.misys.com/eq4/service/ycc";
		_xmlName = "YCC";
	...
	{
		return bf.com.misys.eq4.service.ycc.YCC.class;
	}
