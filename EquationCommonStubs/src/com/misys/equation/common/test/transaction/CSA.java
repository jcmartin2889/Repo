 ...
 */
public class CSA extends EquationTestCaseAddOnce
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: CSA.java 4721 2009-09-15 11:14:17Z weddelc1 $";
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZNMP", "100"); // Notional maturity price per 100
