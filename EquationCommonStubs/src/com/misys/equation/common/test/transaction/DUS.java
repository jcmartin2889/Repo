 ...
 */
public class DUS extends EquationTestCaseFully
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: DUS.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	{
		transaction.setFieldValue("GZUSID", "USER"); // User id being maintained (4A)
	}
	...
	{
		transaction.setFieldValue("GZUNAM", "User Name 1"); // User name (35A)
	}
