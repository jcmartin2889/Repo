...
/**
 * Equation test cases for the ADD part of the (Watch List) Check Clean Payments function (see the EWP_Maintain.java class for the
 * MAINTAIN part). The AddMaintain and AddOnce classes are not appropriate for EWP because it is a non-standard function and sets @FCT
 ...
 * */
public class EWP_AddMore extends EquationTestCaseAddMore
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: EWP_AddMore.java 8213 2010-07-15 16:56:49Z CHALLIP1 $";
	...
	/**
	 * Setup an existing key fields. NB. Existing clean payment, but without an existing WLC case.
	 */
	@Override
	public void setupExistKeyFields(EquationStandardTransaction transaction)
	{
		transaction.setFieldValue("GZPCLP", "KBSL00103H000012"); // Clean payment (16A)
		transaction.setFieldValue("GZPEXT", ""); // External reference (16A)
		/**
		 * Although not actual key fields, these are needed here. Otherwise, case status will be incorrect, i.e. a no hit status
		 * after the last test.
