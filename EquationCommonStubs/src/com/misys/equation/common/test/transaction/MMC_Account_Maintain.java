 ...
 */
public class MMC_Account_Maintain extends EquationTestCaseMaintain
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: MMC_Account_Maintain.java 8426 2010-07-29 17:32:49Z CHALLIP1 $";
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		// Common GZ/GS fields
		String branch = "0132"; // branch
		String basic = "ZZ008"; // basic number
	...
	{
		transaction.setFieldValue("GSNP1", "ESTHER JUNIT"); // Branch name (20A)
	}
