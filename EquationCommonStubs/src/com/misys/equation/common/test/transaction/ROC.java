...
public class ROC extends EquationTestCase
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: ROC.java 8213 2010-07-15 16:56:49Z CHALLIP1 $";
	String paymentType = "888";
	String paymentReference = "KBSL00103H000024";

	long startTime = System.currentTimeMillis();
	long currentTime = startTime;
	private String programName = "K63MRR";
	private String optionId = "ROC";
	...
	public void test00100RetrieveDetails()
	{
		try
		{
			...
			// **********************************************
			requestCancelCleanPayment.setFieldValue("GZDECD", "R"); // Decode; R/S=Canc req,C/D=Canc conf,A/B=Canc abort (1A)
