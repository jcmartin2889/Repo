...
/**
 * Equation test cases for Maintain Security
 */
public class MSA extends EquationTestCaseMaintain
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: MSA.java 4721 2009-09-15 11:14:17Z weddelc1 $";
	String programName = "M21MRR";
	String optionId = "MSA";
	...
	{
		transaction.setFieldValue("GZSMN", "BIAN"); // Security mnemonic
	}
	...
	{
		transaction.setFieldValue("GZSDS", "Changed Security"); // Security description
		transaction.setFieldValue("GZSTY", "EBD"); // Security type
		transaction.setFieldValue("GZCCY", "GBP"); // Currency mnemonic
		transaction.setFieldValue("GZRCL", "MISYS"); // Revaluation class
