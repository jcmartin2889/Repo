 ...
 */
public class AddTest_IRM extends EquationTestCaseMaintain
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AddTest_IRM.java 4721 2009-09-15 11:14:17Z weddelc1 $";
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZIDLP", "XXX"); // Deal type (3A)
	}
	...
	public void setupMaintFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZMDT", "1000504"); // Maturity date (7S,0)
