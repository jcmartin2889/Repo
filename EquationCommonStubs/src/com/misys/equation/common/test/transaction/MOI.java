 ...
 */
public class MOI extends EquationTestCaseMaintain
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: MOI.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupMaintFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZSCHL", "TRANSACTIONS.CHN"); // Server Channel
		transaction.setFieldValue("GZTIME", "0001"); // Daily time to get retail rates
	}
	/**
