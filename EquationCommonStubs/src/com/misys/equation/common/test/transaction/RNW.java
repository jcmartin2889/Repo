...
public class RNW extends EquationTestCaseMaintain
{
	...
	public static final String _revision = "$Id: RNW.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	{
		transaction.setFieldValue("GZREF", "CMF01"); // Notice withdrawal reference
		transaction.setFieldValue("GZAB", "0543"); // Account branch
	...
	{
		transaction.setFieldValue("GZRVW", "Y");
	}
