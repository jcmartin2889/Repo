...
public class ADO extends EquationTestCaseFully
{
	...
	public static final String _revision = "$Id: ADO.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	{
		  transaction.setFieldValue("GZCUS", "133463"); // Customer mnemonic (6A)
		  ...
		  transaction.setFieldValue("GZLNR", "133463"); // Loan reference (13A)
