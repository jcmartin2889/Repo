...
public class MXH extends EquationTestCaseMaintainCancel
{
	...
	public static final String _revision = "$Id: MXH.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	{
		transaction.setFieldValue("GZBBN", "0132"); // Branch number (4A)
		transaction.setFieldValue("GZBNO", "012008"); // Customer number (6A)
		transaction.setFieldValue("GZSFX", "020"); // Account suffix (3A)
		transaction.setFieldValue("GZHNO", "002"); // Hold number (3P,0)
	}
	...
	public void setupMaintFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZINP", "991231"); // Input date (7S,0)
