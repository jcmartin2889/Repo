...
public class MFX extends EquationTestCaseMaintain
{
	...
	public static final String _revision = "$Id: MFX.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZDLR", "Y2F0301"); // Deal reference (13A)
	...
	{
		transaction.setFieldValue("GZBKC", "CC"); // Broker code (2A)
		transaction.setFieldValue("GZBFT", "F"); // Broker fee type (1A)
	}
