 ...
 */
public class MCG extends EquationTestCaseFully
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: MCG.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	{
		transaction.setFieldValue("GZCLCD", "C"); // Card limit code
	}
	...
	{
		transaction.setFieldValue("GZOFPD", "02"); // Offline period
	}
