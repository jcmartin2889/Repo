 ...
 */
public class AddTest_CII_2 extends EquationTestCaseFullyAdd
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AddTest_CII_2.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZCITM", "BIAN"); // Item name
	...
	{
		transaction.setFieldValue("GZDES", "Bianz's Item"); // Item description
