...
/**
 * Equation test cases for Receive Currency from Banks
 */
public class J22 extends EquationTestCaseAddMore
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: J22.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZAS", "105"); // Account suffix
	}
	...
	{
		transaction.setFieldValue("GZIFNC", "RCFB"); // Input function
