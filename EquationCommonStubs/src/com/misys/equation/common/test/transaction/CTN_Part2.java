 ...
 */
public class CTN_Part2 extends EquationTestCaseCancel
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: CTN_Part2.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZPIF", "I"); // Repayment type; I=Interest, P=Principal, B=Both (1A)
	...
	public void setupExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZDLR", "Y2CL203"); // Deal reference (13A)
		transaction.setFieldValue("GZBRNM", "CITY"); // Branch mnemonic (4A)
		transaction.setFieldValue("GZDTE", "1000229"); // Repayment due date (7S,0)
		transaction.setFieldValue("GZPIF", "I"); // Repayment type; I=Interest, P=Principal, B=Both (1A)
		//transaction.setFieldValue("GZVF1", "1000104"); // Principal repayment date (7S,0)
	}
