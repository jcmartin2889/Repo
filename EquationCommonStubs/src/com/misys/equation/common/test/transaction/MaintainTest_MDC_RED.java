 ...
 */
public class MaintainTest_MDC_RED extends EquationTestCaseMaintain
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: MaintainTest_MDC_RED.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		{
			transaction.setFieldValue("GZ9OLR", "054301050003"); // Transaction refer
		}
		transaction.setFieldValue("GZ9MOD", "P"); // Process mode (1A)
	}
