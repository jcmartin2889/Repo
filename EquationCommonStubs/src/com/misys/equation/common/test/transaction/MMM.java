 ...
 */
public class MMM extends EquationTestCaseMaintain	
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: MMM.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZDLR", "1003"); // Deal reference (13A)
		transaction.setFieldValue("GZBRNM", "LOND"); // Branch mnemonic (4A)
	}
	...
	public void setupMaintFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZSDT", "0991230"); // Start date (7S,0)
		transaction.setFieldValue("GZMDT", "1000129"); // Maturity date (7S,0)
		transaction.setFieldValue("GZCTRD", "0991230"); // Contract date (7S,0)
		transaction.setFieldValue("GZRAT", "150"); // Actual rate (11P,7)
		transaction.setFieldValue("GZPEN", "0"); // Penalty rate (11P,7)
