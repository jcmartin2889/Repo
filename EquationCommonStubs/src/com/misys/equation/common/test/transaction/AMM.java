 ...
 */
public class AMM extends EquationTestCaseAddOnce
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AMM.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZPCDI", "N"); // Period code derived indic (1A)
		transaction.setFieldValue("GZTADT", "1"); // Tax advice type (1A)
		//
		// Should be changed to reflect the one who cancels the MM deal.
		transaction.setFieldValue("GZUSID", "ANTO"); // User id associated with last update (4A)
	}
