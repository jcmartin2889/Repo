 ...
 */
public class POM extends EquationTestCaseMaintain
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: POM.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	String programName = "V23MRR";
	String optionId = "POM";
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZSOR", "00999"); // Payment order reference (5A)
	}
	...
	{
		transaction.setFieldValue("GZAFR", "V20"); // Frequency code (3A)
