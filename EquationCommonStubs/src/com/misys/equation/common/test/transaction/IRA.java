...
/**
 * Equation test cases for Add Interest Rate Swap
 */
public class IRA extends EquationTestCaseAddOnce
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: IRA.java 4721 2009-09-15 11:14:17Z weddelc1 $";
	...
	{
		transaction.setFieldValue("GZDLR", "IVDTEST003"); // Deal reference (13A)
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZRBRR", "01"); // Base rate code - secondary (2A)
		...
		transaction.setFieldValue("GZRNR", "1000101"); // Next reset date - secondary (7S,0
