...
/**
 * Equation test cases for Add Extended Account Holds
 */
public class AXH extends EquationTestCaseAddMore
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AXH.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	{
		transaction.setFieldValue("GZAMTH", "8000"); // Hold amount (15P,0)
		transaction.setFieldValue("GZACO", "CRT"); // Responsibility code (3A)
		transaction.setFieldValue("GZHRC", "IRC"); // Hold reason code (3A)
		transaction.setFieldValue("GZSTD", "1000105"); // Start date (7S,0)
		transaction.setFieldValue("GZEXD", "OPEN"); // Expiry date (7S,0)
