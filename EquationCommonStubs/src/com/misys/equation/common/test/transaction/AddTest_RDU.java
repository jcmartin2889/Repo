 ...
 */
public class AddTest_RDU extends EquationTestCaseAddOnce
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AddTest_RDU.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZDLR", "EQ4-RAF-04"); // Deal reference (13A)
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZCLC", "002"); // Customer location (3A)
		...
		transaction.setFieldValue("GZPRC", "M1  "); // Period code (4A)
		...
		transaction.setFieldValue("GZDDE", "0991230"); // Date deal entered (7S,0)
		...
		//transaction.setFieldValue("GZASD", "101"); // Deal account suffix (3A)
