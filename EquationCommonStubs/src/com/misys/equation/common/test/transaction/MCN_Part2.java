 ...
 */
public class MCN_Part2 extends EquationTestCaseMaintainCancel
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: MCN_Part2.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupMaintFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZNBCY", "Y"); // Net in base currency pairs? (1A)
