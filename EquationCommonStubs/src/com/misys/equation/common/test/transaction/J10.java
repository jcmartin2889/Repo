 ...
 */
public class J10 extends EquationTestCaseFully
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: J10.java 4721 2009-09-15 11:14:17Z weddelc1 $";
	...
	{
		transaction.setFieldValue("GZCCY", "PHP"); // Currency mnemonic
	}
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZNS01", "005"); // 1st note a/c suffix
	...
	{
		transaction.setFieldValue("GZNX01", "Carl's Currency Denomination change"); // 1st note den. desc.
	}
