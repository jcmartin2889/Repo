...
/**
 * Equation test cases for Maintain Model Security
 */
public class MSM extends EquationTestCaseMaintain
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: MSM.java 4721 2009-09-15 11:14:17Z weddelc1 $";
	String programName = "M20MRR";
	String optionId = "MSM";
	...
	{
		transaction.setFieldValue("GZSDS", "Carl's Model Security"); // Security description
