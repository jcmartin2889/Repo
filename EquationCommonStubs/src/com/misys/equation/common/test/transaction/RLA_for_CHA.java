 ...
 */
public class RLA_for_CHA extends EquationTestCaseAddMore
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: RLA_for_CHA.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZLNR", "INVALIDDEAL"); // Loan reference
	}
	...
	{
		transaction.setFieldValue("GZLNP", "AP1"); // Loan type
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZSDT", "1000105"); // Start date
		...
		transaction.setFieldValue("GZFDT", "1000205"); // First repayment date
