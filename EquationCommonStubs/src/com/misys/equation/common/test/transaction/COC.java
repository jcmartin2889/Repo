...
public class COC extends EquationTestCase
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: COC.java 8213 2010-07-15 16:56:49Z CHALLIP1 $";
	...
	public void test00100RetrieveDetails()
	{
		try
		{
			...
			// **********************************************
			requestCancelCleanPayment.setFieldValue("GZDECD", "C"); // Decode; R/S=Canc req,C/D=Canc conf,A/B=Canc abort (1A)
