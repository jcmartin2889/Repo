 ...
 */
public class AddTest_MAT_GenericX extends EquationTestCaseFullyAdd
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AddTest_MAT_GenericX.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZSCON", "Y"); // Special conditions set on?
		// transaction.setField("GZACT", "3"); // Action if no avail balance
		transaction.setFieldValue("GZSCM", "NNNNNNNNNNNNNNNNNNNNNNNNNNNNNNYNNNNNN"); // Special condition maintained?
		// transaction.setField("GZCCY", "GBP"); // Currency
	}
