 ...
 * @author weddelc1
 */
public class ERF_2 extends EquationTestCaseAddOnce
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: ERF_2.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	String programName = "G49FRR"; // Manual Posting Reconciliation
	String optionId = "ERF";
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZPSQ7", "0000057"); // 7 Long posting sequence number (7P,0)
	}
