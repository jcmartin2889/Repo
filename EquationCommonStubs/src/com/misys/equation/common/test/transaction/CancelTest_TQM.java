 ...
 * @author weddelc1
 */
public class CancelTest_TQM extends EquationTestCaseAddOnce
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: CancelTest_TQM.java 8213 2010-07-15 16:56:49Z CHALLIP1 $";
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZQEVM", "ITA"); // Events (6A)
