...
public class MNS extends EquationTestCaseMaintain
{
	...
	public static final String _revision = "$Id: MNS.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZLNP", "AP3"); // Loan type (3A)
		transaction.setFieldValue("GZLNR", "AP003"); // Loan reference (13A)
	}
