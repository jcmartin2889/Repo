 ...
 */
public class CancelTest_ITM_for_EQP extends EquationTestCaseMaintainCancel
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: CancelTest_ITM_for_EQP.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZTREF", reference); // Transfer reference (16A)
	...
	public void setupMaintFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZQEVM", optionId); // Events (6A)
	}
