 ...
 */
public class CTU extends EquationTestCaseFully
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: CTU.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	// Note this is the effectively identical to CAN
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		 ...
		 */
		transaction.setFieldValue("GZCLR", "CN146863 COLL REF"); // Collateral reference (35A)
	}
