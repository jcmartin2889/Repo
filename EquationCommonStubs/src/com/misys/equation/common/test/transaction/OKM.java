...
/**
 * Equation test cases for Maintain function Review Commercial Paper Group
 */
public class OKM extends EquationTestCaseMaintainCancel
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: OKM.java 8213 2010-07-15 16:56:49Z CHALLIP1 $";
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZRVW", "Y"); // Reviewed? (1A)
		transaction.setFieldValue("GZAUT", "N"); // Authorised? (1A)
	}
	...
	public void setupMaintFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZTOT", "10000"); // Total Available (15P,0)
