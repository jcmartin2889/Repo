 ...
 */
public class OKI extends EquationTestCaseFully
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: OKI.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZF17", "N"); // F17 Flag (1A)
	}
	...
	public void setupMaintFields(EquationStandardTransaction transaction)
	{
		...
		// transaction.setFieldValue("GZMAN", "123467"); // Basic part of account number (6A)
		// transaction.setFieldValue("GZMAS", "001"); // Account suffix (3A)
		transaction.setFieldValue("GZDTC", "015"); // Transaction code (3A)
		transaction.setFieldValue("GZCTC", "515"); // Transaction code (3A)
	}
