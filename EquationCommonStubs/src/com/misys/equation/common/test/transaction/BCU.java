 ...
 */
public class BCU extends EquationTestCaseFully
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: BCU.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	String programName = "C11FRR";
	String optionId = "BCU";
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZCUSL", "ATLANT"); // Lending customer name (6A)
	...
	{
		transaction.setFieldValue("GZNR1", "BORROWED 1"); // Reason for borrowing - line 1 (35A)
	}
}
