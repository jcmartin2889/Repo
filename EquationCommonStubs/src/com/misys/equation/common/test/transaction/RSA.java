...
/**
 * Equation test cases for Add Security Based on Model
 */
public class RSA extends EquationTestCaseAddOnce
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: RSA.java 4721 2009-09-15 11:14:17Z weddelc1 $";
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZBSP", "CARL"); // Base on security
	}
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		transaction.setFieldValue("GZSMN", "MISYS"); // Security mnemonic
		transaction.setFieldValue("GZBSP", "CARL"); // Base on security
		transaction.setFieldValue("GZSDS", "Carl's Security"); // Security description
		transaction.setFieldValue("GZSTY", "BIA"); // Security type
