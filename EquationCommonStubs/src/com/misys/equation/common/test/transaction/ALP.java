...
public class ALP extends EquationTestCaseAddMore
{
	...
	public static final String _revision = "$Id: ALP.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	{
		transaction.setFieldValue("GZLNP", "CAM"); // Loan type (3A)
		transaction.setFieldValue("GZLNR", "COA22"); // Loan reference (13A)
		transaction.setFieldValue("GZBRNM", "CUTE"); // Branch mnemonic (4A)
		transaction.setFieldValue("GZCCY", "USD"); // Currency mnemonic (3A)
		transaction.setFieldValue("GZRPA", "10000"); // Repayment amount (15P,0)
		transaction.setFieldValue("GZVDT", "1000105"); // Payment value date (7S,0)
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZAN", "Z00001"); // Pay from a/c number (6A)
		transaction.setFieldValue("GZAS", "011"); // Pay from a/c suffix (3A)
