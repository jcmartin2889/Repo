...
/**
 * Equation test cases for Transfer Notes from Part Mut Stock
 */
public class J47 extends EquationTestCaseAddMore
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: J47.java 8426 2010-07-29 17:32:49Z CHALLIP1 $";
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZAB", "9998"); // Account branch
	}
	...
	{
		transaction.setFieldValue("GZIFNC", "TCOP"); // Input function
