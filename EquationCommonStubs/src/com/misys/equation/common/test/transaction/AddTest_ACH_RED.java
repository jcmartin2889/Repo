 ...
 */
public class AddTest_ACH_RED extends EquationTestCaseFullyAdd
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AddTest_ACH_RED.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	{
		transaction.setFieldValue("GZ1CAB", "9132"); // Drawn on account branch number (4A)
		transaction.setFieldValue("GZ1CAN", "666666"); // Drawn on account customer number (6A)
		transaction.setFieldValue("GZ1CAS", "001"); // Drawn on account suffix (3A)              
