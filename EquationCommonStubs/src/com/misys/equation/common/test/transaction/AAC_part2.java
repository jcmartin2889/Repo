 ...
 */
public class AAC_part2 extends EquationTestCaseMaintainCancel
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AAC_part2.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	{
		transaction.setFieldValue("GZINTR", "1"); // Rule instruction type; 1=Post,2=Chrg,3=Hold,4=Rpt (1A)
		transaction.setFieldValue("GZISET", "AUTHSET"); // Rule instruction set id (10A)
	}
