...
public class ACH_AddMaintainCancelSingleChequeItem extends EquationTestCaseAddOnce
{
	...
	public static final String _revision = "$Id: ACH_AddMaintainCancelSingleChequeItem.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZ1SRL","1140317133521");
		...
		//transaction.setFieldValue("GZ1SRL", "123"); // Cheque serial number (16A)
