...
public class AddTest_RDU_MBT extends EquationTestCaseFullyAdd
{
	...
	public static final String _revision = "$Id: AddTest_RDU_MBT.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZFND", ""); // Funding rules? (1A)
		transaction.setFieldValue("GZWDL", ""); // Withdrawal rules? (1A)
