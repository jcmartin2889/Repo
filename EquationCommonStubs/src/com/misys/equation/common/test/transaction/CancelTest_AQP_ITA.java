 ...
 */
public class CancelTest_AQP_ITA extends EquationTestCaseFullyCancel
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: CancelTest_AQP_ITA.java 8213 2010-07-15 16:56:49Z CHALLIP1 $";
	...
	{
		transaction.setFieldValue("GZEVM", "ITA"); // Event (6A)
		transaction.setFieldValue("GZTCD", "010"); // Transaction code (3A)
		// transaction.setField("GZPTY", "00020"); // Priority code (5A)
