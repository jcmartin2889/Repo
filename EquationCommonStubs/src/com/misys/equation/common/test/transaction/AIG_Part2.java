 ...
 */
public class AIG_Part2 extends EquationTestCaseMaintain
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AIG_Part2.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZCFL", "AB"); // Parameter value
	}
	...
	/**
	 * Checking for non-existing records happens in the update module. The following will not issue errors and therefore are
	 * invalid.
	 */
	@Override
