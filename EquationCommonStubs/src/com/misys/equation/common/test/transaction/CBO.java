 ...
 */
public class CBO extends EquationTestCaseCancel
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: CBO.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	String programName = "H13CRR";
	String optionId = "CBO";
	...
	{
		transaction.setFieldValue("GZAB", "01X2"); // Balance order branch (4A)
		transaction.setFieldValue("GZAN", "20X000"); // Balance order account number (6A)
		transaction.setFieldValue("GZAS", "X0X"); // Balance order suffix (3A)
