 ...
 */
public class ANW_2_Settlement extends EquationTestCaseAddOnce
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: ANW_2_Settlement.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZAB", "0543"); // Instruction a/c branch
		transaction.setFieldValue("GZAN", "234567"); // Instruction a/c number
		transaction.setFieldValue("GZAS", "201"); // Instruction a/c suffix
		transaction.setFieldValue("GZPYT", "NSA"); // Settlement type
		transaction.setFieldValue("GZREF", "REF005"); // Settlement reference
	}
