...
public class AIN extends EquationTestCase
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AIN.java 8213 2010-07-15 16:56:49Z CHALLIP1 $";
	long startTime = System.currentTimeMillis();
	long currentTime = startTime;

	String paymentReference = "KBSL00103H000011";

	private String programName = "K62MRR";
	private String optionId = "AIN";
	...
	public void test00100Retrieve()
	{
		try
		{
			...
			authoriseOutwardCleanPayment.setFieldValue("GZDECD", "I"); // Decode; O/I=Auth,P/J=Susp,C=Conf,L=Coll (1A)
