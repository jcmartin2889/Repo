 ...
 */
public class MTN extends EquationTestCaseMaintain
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: MTN.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZDTE", "0990831"); // Repayment due date (7S,0)
		transaction.setFieldValue("GZPIF", "P"); // Repayment type; I=Interest, P=Principal, B=Both (1A)
		transaction.setFieldValue("GZBVF", "0990831"); // Before maintenance value date (7S,0)
	...
	public void setupMaintFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZAM1", "95000"); // Principal repayment amount (15P,0)
		...
		transaction.setFieldValue("GZD11", "Maintained 2"); // Principal details line 1 (35A)
	}
