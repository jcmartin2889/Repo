 ...
 */
public class DCH extends EquationTestCaseFullyList2
{
	...
	{
		transaction.setFieldValue("GZAPP", "CP"); // Application (2A)
		transaction.setFieldValue("GZCRST", "REC-ADMINA"); // Charge Set (10A)
		transaction.setFieldValue("GZCUS", "MARTS"); // Customer Mnemonic (6A)
		transaction.setFieldValue("GZCLC", "BNK"); // Customer Location (3A)
