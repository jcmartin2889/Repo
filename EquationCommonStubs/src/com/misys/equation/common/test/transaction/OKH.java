 ...
 */
public class OKH extends EquationTestCaseFully
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: OKH.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	{
		transaction.setFieldValue("GZMAT", "RO"); // Customer Memo A/C Type (2A)
		transaction.setFieldValue("GZMWT", "RO"); // Memo Cust Weightage a/c Type (2A)
	}
