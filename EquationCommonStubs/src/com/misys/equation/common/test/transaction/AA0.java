...
public class AA0 extends EquationTestCaseMaintainCancel
{
	...
	public static final String _revision = "$Id: AA0.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	{
		transaction.setFieldValue("GZBRST", "Z96912345"); // Drawee BRSTN (9A)
		transaction.setFieldValue("GZDOCN", "00000000"); // Document ID No. (9A)
	}
