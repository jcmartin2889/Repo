 ...
 */
public class AddTest_MAT extends EquationTestCaseFullyAdd
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AddTest_MAT.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	{
		transaction.setFieldValue("GZATP", "JA"); // Account type
		transaction.setFieldValue("GZAPP", "MS"); // Application code; FX, MM, " ", SW, CL, MS, CP, IR,
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZHVS", "999"); // Highest valid suffix for account type
		...
		transaction.setFieldValue("GZLVS", "000"); // Lowest valid suffix for account type
		...
		transaction.setFieldValue("GZIBAN", "Y"); // IBAN generation required?
		transaction.setFieldValue("GZILS", "001Y"); // Interval since last statement

		transaction.setFieldValue("GZCIBP", "N"); // Capitalise int before paying?
		transaction.setFieldValue("GZEXTP", "N"); // Allow external int pay?
		...
		transaction.setFieldValue("GZACT", "3"); // Action if no avail balance
		transaction.setFieldValue("GZSCM", "NNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNY"); // Special condition maintained?
	}
