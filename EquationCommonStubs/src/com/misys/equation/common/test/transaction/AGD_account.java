 ...
 */
public class AGD_account extends EquationTestCaseFully
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AGD_account.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	{
		transaction.setFieldValue("GZAMTG", "17500"); // Guarantee amount (15P,0)
		transaction.setFieldValue("GZCCYG", "USD"); // Guarantee currency (3A)
		// transaction.setFieldValue("GZXDTG", "9999999"); // Guarantee expiry date (7S,0)
		// transaction.setFieldValue("GZGTPG", "GT3"); // Guarantee type (3A)
