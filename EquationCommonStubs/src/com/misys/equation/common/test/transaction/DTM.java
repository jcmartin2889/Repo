...
public class DTM extends EquationTestCaseFully
{
	...
	public static final String _revision = "$Id: DTM.java 4721 2009-09-15 11:14:17Z weddelc1 $";
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZRTN", "10"); // Default minimum rate
		transaction.setFieldValue("GZMAX", "Y"); // Maximum rate allowed?
		transaction.setFieldValue("GZRTX", "20"); // Default maximum rate
	}
