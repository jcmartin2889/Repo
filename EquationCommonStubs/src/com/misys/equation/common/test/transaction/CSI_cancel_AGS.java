 ...
 */
public class CSI_cancel_AGS extends EquationTestCaseCancel
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: CSI_cancel_AGS.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	String programName = "H15CRR";
	String optionId = "CSI";
	String addOptionId = "AGS";
