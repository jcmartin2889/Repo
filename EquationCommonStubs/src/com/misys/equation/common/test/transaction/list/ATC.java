...
/**
 * Equation test cases for Add/Maintain CA Tran Code Mapping
 */
public class ATC extends EquationTestCaseFullyList2
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: ATC.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	String programName = "W22LRR";
	String optionId = "ATC";
