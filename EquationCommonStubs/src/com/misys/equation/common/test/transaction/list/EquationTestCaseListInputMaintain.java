...
/**
 * Test cases for List Input (Pattern 4) APIs that only support maintenance of items (not Add/Delete).
 * 
 * Note that the non-repeating (GZ) aspect of the API may support different features For example,
 */
abstract public class EquationTestCaseListInputMaintain extends EquationTestCase
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: EquationTestCaseListInputMaintain.java 11003 2011-05-19 14:03:48Z MACDONP1 $";
	 ...
	 * @throws Exception
	 */
	public void test00900Add_NewGSs() throws Exception
	{
		System.out.println("test00900Add_NewGSRecord()");
		// EquationStandardListTransaction transaction = getTransaction();
		// transaction.setMode(EquationStandardTransaction.FCT_ADD);
		// // transaction.setMode(EquationStandardTransaction.FCT_MNT);
		//
	 ...
	 * @throws Exception
	 */
	public void test01000Maintain_GSs() throws Exception
	{
		System.out.println("test01000Maintain_GSs()");
		EquationStandardGSListTransaction transaction = getTransaction();
