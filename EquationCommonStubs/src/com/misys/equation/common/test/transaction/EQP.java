...
public class EQP extends EquationTestCaseAddMore
{
	...
	public static final String _revision = "$Id: EQP.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZQAB", "0000"); // Original queued against account branch (4A)
		transaction.setFieldValue("GZQAN", "500035"); // Original queued against account number (6A)
		transaction.setFieldValue("GZQAS", "102"); // Original queued against account suffix (3A)
	...
	{
		String reference = TestEnvironment.getTestEnvironment().getParameter("ITA");
		transaction.setFieldValue("GZEVM", "ACCS"); // User defined event (6A)
		transaction.setFieldValue("GZQAB", "0543"); // Original queued against account branch (4A)
		transaction.setFieldValue("GZQAN", "202001"); // Original queued against account number (6A)
		transaction.setFieldValue("GZQAS", "001"); // Original queued against account suffix (3A)
		transaction.setFieldValue("GZOAB", ""); // Original owning account branch (4A)
		transaction.setFieldValue("GZOAN", ""); // Original owning account number (6A)
		transaction.setFieldValue("GZOAS", ""); // Original owning account suffix (3A)
		transaction.setFieldValue("GZBRM", ""); // Deal branch (4A)
		transaction.setFieldValue("GZDLP", ""); // Deal type (3A)
		transaction.setFieldValue("GZDLR", ""); // Deal reference (13A)
		transaction.setFieldValue("GZCMR", ""); // Commitment reference (13A)
		transaction.setFieldValue("GZTRN", "A1"); // Transaction reference (16A)
		transaction.setFieldValue("GZDTE", "991231"); // Transaction date (7S,0)
		transaction.setFieldValue("GZDRF", ""); // Subsidiary reference (16A)
		transaction.setFieldValue("GZTSQ", "1"); // Transaction sequence number (16P,0)
		transaction.setFieldValue("GZESQ", "0"); // Event sequence number (7P,0)
	}
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZPTY", "00200"); // New priority code (5A)
