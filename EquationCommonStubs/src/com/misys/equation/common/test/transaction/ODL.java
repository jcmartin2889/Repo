 ...
 */
public class ODL extends EquationTestCaseFully
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: ODL.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZCNA", "1150"); // Corporate normal charge amount (15,0)

		transaction.setFieldValue("GZCEC", "AD"); // Corporate excess charge code (2A)
		transaction.setFieldValue("GZCEA", "1250"); // Corporate excess charge amount (15,0)
		...
		// transaction.setFieldValue("GZINA", "1450"); // Individual normal charge amount (15,0)

		// transaction.setFieldValue("GZIEC", "A4"); // Individual excess charge code (2A)
		// transaction.setFieldValue("GZIEA", "1550"); // Individual excess charge amount (15,0)
