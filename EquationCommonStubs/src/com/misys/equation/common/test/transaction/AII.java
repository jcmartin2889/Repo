...
/**
 * Equation test cases for Authorise Interest Instructions
 */
public class AII extends EquationTestCaseMaintain
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AII.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZAS", "191"); // Account suffix
	}
	...
	{
		// Invalid test. Cannot maintain an already authorised interest instruction.
	}
}
