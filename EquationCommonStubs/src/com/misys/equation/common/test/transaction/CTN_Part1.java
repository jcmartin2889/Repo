 ...
 */
public class CTN_Part1 extends EquationTestCaseCancel
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: CTN_Part1.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZDTE", "1000205"); // Repayment due date (7S,0)
		transaction.setFieldValue("GZPIF", "P"); // Repayment type; I=Interest, P=Principal, B=Both (1A)
		//transaction.setFieldValue("GZVF1", "1000103"); // Principal repayment date (7S,0)
