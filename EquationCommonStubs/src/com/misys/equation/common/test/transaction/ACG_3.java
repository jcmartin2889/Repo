 ...
 * @author weddelc1
 */
public class ACG_3 extends EquationTestCase
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: ACG_3.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void testAdd() throws Exception
	{
		...
		transaction.setGSFieldValue("GSECNM", "RLA001"); // percentage rate
		transaction.setGSFieldValue("GSCHGC", "");
		transaction.setGSFieldValue("GSPAMT", "20.500");
		...
		transaction.setGSFieldValue("GSFAB", "0000");
		transaction.setGSFieldValue("GSFAN", "000001");
