...
/**
 * Equation test cases for Add Security
 */
public class Addtest_CSA extends EquationTestCaseAddOnce
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: Addtest_CSA.java 4721 2009-09-15 11:14:17Z weddelc1 $";
	String programName = "M21ARR";
	String optionId = "CSA";
	...
	{
		transaction.setFieldValue("GZSMN", "ISSUESEC"); // Security mnemonic
		transaction.setFieldValue("GZSDS", "Security for Issue"); // Security description
		transaction.setFieldValue("GZSTY", "EBD"); // Security type
		...
		transaction.setFieldValue("GZMDT", "1000131"); // Maturity date
		transaction.setFieldValue("GZIPR", "1"); // Issue price per 100
		transaction.setFieldValue("GZISS", "Y"); // Own issue (1A)
		transaction.setFieldValue("GZIDT", "991231"); // Issue date (7S,0)
		...
		transaction.setFieldValue("GZDN1", "10000"); // Minimum denomination (15P,0)
		transaction.setFieldValue("GZDN2", "10000"); // Maximum denomination (15P,0)
		transaction.setFieldValue("GZISZ", "100"); // Issue size (15P,0)
		transaction.setFieldValue("GZIAO", "100"); // Issue amount outstanding (15P,0)
		transaction.setFieldValue("GZIPR", "1500.0000000"); // Issue price per 100 (11P,7)
	}
