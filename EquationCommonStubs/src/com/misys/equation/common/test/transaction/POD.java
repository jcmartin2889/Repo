...
/**
 * Equation test cases for Cancel Customer Payment Order
 */
public class POD extends EquationTestCaseFullyCancel
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: POD.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	String programName = "V23CRR";
	String optionId = "POD";
