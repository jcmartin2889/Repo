 ...
 */
public class AddTest_CIA extends EquationTestCaseFullyAdd

{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AddTest_CIA.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZA42", "Y"); // Amend overdraft confirmation (1A)
	}
