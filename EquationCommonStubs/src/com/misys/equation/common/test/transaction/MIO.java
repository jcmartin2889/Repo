 ...
 */
public class MIO extends EquationTestCaseMaintain
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: MIO.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZAN", "975901"); // Basic part of account number (6A)
		transaction.setFieldValue("GZAS", "380"); // Account suffix (3A)
		transaction.setFieldValue("GZINT", "Y"); // Internal account (1A)
	}
