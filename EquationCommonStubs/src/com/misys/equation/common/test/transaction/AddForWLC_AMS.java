...
/*
 * Equation test cases for Add Money Market Deal with Settlements for testing with K473 Watch List Checking (WLC) NB. MPC FWDLW Deal
 * WLC must be N to prevent a WLC case from being raised with this deal.
 */
public class AddForWLC_AMS extends EquationTestCaseAddOnce
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AddForWLC_AMS.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZBOAN", "OSAMA BIN LADEN"); // Beneficiary account number:59 (34A)
