 ...
 */
public class BCD extends EquationTestCaseMaintain
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: BCD.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	{
		// LYPF is a physical file, therefore has no key fields.
	}
	...
	public void setupMaintFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZACT1", "CA"); // Account type 1 (2A)
	}

	/**
	 * Cannot validate non-existing records since LYPF is assumed to contain 1 record
	 */
	@Override
