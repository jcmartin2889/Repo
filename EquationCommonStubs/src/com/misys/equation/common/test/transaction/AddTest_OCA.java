 ...
 */
public class AddTest_OCA extends EquationTestCaseAddOnce
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: AddTest_OCA.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZACT", "JA"); // Account Type
		transaction.setFieldValue("GZSHN", "Test Account"); // Short Name
		transaction.setFieldValue("GZOAD", "991231"); // Account Open Date
	}
