 ...
 */
public class SDD extends EquationTestCaseFully
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: SDD.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	{
		transaction.setFieldValue("GZSITD", "Carl's Changed Stock Item"); // Stock item description
	}
