 ...
 * @author weddelc1
 */
public class FRS extends EquationTestCaseAddOnce
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: FRS.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setupNonExistKeyFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZDLR", "TEST 13"); // Deal reference (13A)
	...
	public void setupAddFields(EquationStandardTransaction transaction)
	{
		...
		transaction.setFieldValue("GZSDT", "000106"); // Start date (7S,0)
		transaction.setFieldValue("GZMDT", "000107"); // Maturity date (7S,0)
		transaction.setFieldValue("GZCTRD", "000105"); // Contract date (7S,0)
		transaction.setFieldValue("GZFDTD", "000106"); // Maturity date (7S,0)
		transaction.setFieldValue("GZFDDE", "000106"); // Date deal entered (7S,0)
