...
/**
 * Equation test cases for Maintain Account Status
 */
public class ASM_2 extends EquationTestCaseMaintain
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: ASM_2.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	String programName = "I03MRR";
	String optionId = "ASM";
	...
	{
		transaction.setFieldValue("GZNSTC", "00"); // New status (2A)
		transaction.setFieldValue("GZSDOC", "N"); // Suppress customer document? (1A)
