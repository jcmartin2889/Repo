 ...
 * @author weddelc1
 */
public class SMR extends EquationTestCase // Stock Movement Reconciliation
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: SMR.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void testRetrieve() throws Exception
	{
		...
		listEnquiry.setFieldValue("HZCCY", "USD"); // Currency (3A)
