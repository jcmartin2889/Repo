 ...
 * @author weddelc1
 */
public class BL extends EquationTestCase // Balance Order Enquiry
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: BL.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setUp() throws Exception
	{
		 ...
		 */
		enquiry = getEquationStandardEnquiry("H46EER");
	}
	...
	public void testRetrieve() throws Exception
	{
		...
		enquiry.setFieldValue("HZBOT", "L"); // Balance order type (1A)
