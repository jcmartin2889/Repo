 ...
 * @author weddelc1
 */
public class EPO extends EquationTestCase // Customer Payment Order Enquiry
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: EPO.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setUp() throws Exception
	{
		 ...
		 */
		enquiry = getEquationStandardEnquiry("V23EER");
	}
	...
	public void testRetrieve() throws Exception
	{
		 ...
		 */
		enquiry.setFieldValue("HZSOR", "CRG01"); // Payment order reference (5A)
