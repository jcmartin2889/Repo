 ...
 * @author weddelc1
 */
public class IDF extends EquationTestCase // Customer income - FX details
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: IDF.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	public void setUp() throws Exception
	{
		 ...
		 */
		listEnquiry = getEquationStandardListEnquiry("N82DER");
	}
	...
	public void testRetrieve() throws Exception
	{
		...
		listEnquiry.setFieldValue("HZDLP", "FXF"); // Deal type (3A)
