 ...
 */
abstract public class EquationTestCaseAddCancel extends EquationTestCase
{
	// This attribute is used to store cvs version information.
	public static final String _revision = "$Id: EquationTestCaseAddCancel.java 7610 2010-06-01 17:10:41Z MACDONP1 $";
	...
	{
		System.out.println("test00300Cancel_Validate_NonExistingRecord()");
		EquationStandardTransaction transaction = getTransaction();
	...
	{
		System.out.println("test00400Cancel_Retrieval_NonExistingRecord()");
		EquationStandardTransaction transaction = getTransaction();
	...
	{
		System.out.println("test00500Cancel_NonExistingRecord()");
		EquationStandardTransaction transaction = getTransaction();
		transaction.setMode(IEquationStandardObject.FCT_DEL);
		setupNonExistKeyFields(transaction);
